<x-app-layout>
    @section('header', 'Nova Entrega')

    @section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.entregas.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status_entrega_id" id="status_entrega_id" class="form-select @error('status_entrega_id') is-invalid @enderror">
                            ...
                            @foreach($statuses as $status)
                                <option value="{{ $status->id }}" {{ old('status_entrega_id') == $status->id ? 'selected' : '' }}>
                                    {{ $status->nome }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="motoboy_id" id="motoboy_id" class="form-select @error('motoboy_id') is-invalid @enderror">
                            ...
                            @foreach($motoboys as $motoboy)
                                <option value="{{ $motoboy->id }}" {{ old('motoboy_id') == $motoboy->id ? 'selected' : '' }}>
                                    {{ $motoboy->nome }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nome_destinatario" id="nome_destinatario" class="form-control @error('nome_destinatario') is-invalid @enderror" value="{{ old('nome_destinatario') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="codigo_pedido" id="codigo_pedido" class="form-control @error('codigo_pedido') is-invalid @enderror" value="{{ old('codigo_pedido') }}">
                        @error('codigo_pedido')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="conteudo" id="conteudo" rows="3" class="form-control @error('conteudo') is-invalid @enderror">{{ old('conteudo') }}</textarea>
                        @error('conteudo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
