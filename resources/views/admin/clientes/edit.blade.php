        ...
        <div class="card-body">
            <form action="{{ route('admin.clientes.update', $cliente) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="cnpj" id="cnpj" class="form-control @error('cnpj') is-invalid @enderror" value="{{ old('cnpj', $cliente->cnpj) }}" required>
                    @error('cnpj')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" name="url_callback" id="url_callback" class="form-control @error('url_callback') is-invalid @enderror" value="{{ old('url_callback', $cliente->url_callback) }}">
                    @error('url_callback')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="token_autenticacao" id="token_autenticacao" class="form-control @error('token_autenticacao') is-invalid @enderror" value="{{ old('token_autenticacao', $cliente->token_autenticacao) }}">
